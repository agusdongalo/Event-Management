          ...
          <div className="mt-4 grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
            <article className="rounded-xl bg-white p-4 shadow-sm">
              <div className="mb-4 flex items-center justify-between">
                <h2 className={`${headingFont.className} text-2xl text-[#1b2441]`}>Profile Details</h2>
                <button
                  type="button"
                  className="rounded-md border border-[#dde2f0] px-3 py-1.5 text-xs text-[#4a5b87]"
                >
                  Edit Profile
                </button>
              </div>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Full Name</p>
                  <p className="mt-2 text-sm font-semibold text-[#1b2441]">{user.name}</p>
                </div>
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Email Address</p>
                  <p className="mt-2 text-sm font-semibold text-[#1b2441]">{user.email}</p>
                </div>
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Role</p>
                  <p className="mt-2 text-sm font-semibold text-[#1b2441]">Organizer</p>
                </div>
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Status</p>
                  <p className="mt-2 text-sm font-semibold text-[#1b2441]">Active</p>
                </div>
              </div>
            </article>
            ...
            <article className="rounded-xl bg-white p-4 shadow-sm">
              ...
              <div className="space-y-3 text-sm text-[#2a3659]">
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Password</p>
                  <p className="mt-2 font-semibold text-[#1b2441]">************</p>
                </div>
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Two-Factor Authentication</p>
                  <p className="mt-2 font-semibold text-[#1b2441]">Not enabled</p>
                </div>
                <div className="rounded-lg border border-[#eef1f7] bg-[#f9fafe] px-4 py-3">
                  <p className="text-xs text-[#7b86a6]">Login Alerts</p>
                  <p className="mt-2 font-semibold text-[#1b2441]">Enabled</p>
                </div>
              </div>
            </article>
          </div>
