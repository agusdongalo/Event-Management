        ...
        <aside className="bg-[linear-gradient(180deg,#2b3f66_0%,#1b2a4a_45%,#13223b_100%)] px-5 py-6 text-white">
          ...
          <nav className="mt-6 space-y-2 text-sm">
            {[
              ...
              { label: "Attendees", href: "/admin/attendees", active: true },
        ...
        <section className="organizer-content p-5 md:p-7">
          <header className="relative z-0 mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className={`${headingFont.className} text-3xl text-[#1b2441]`}>Attendees</h1>
            </div>
          ...
          <div className="organizer-top-shadow relative z-10 rounded-2xl bg-white p-4 shadow-sm">
            <div className="grid gap-2 text-sm font-semibold text-[#4a5b87] sm:grid-cols-[1.4fr_1fr_0.7fr_0.7fr]">
              <span>Guest</span>
              <span>Event</span>
              <span>Tier</span>
              <span>Status</span>
